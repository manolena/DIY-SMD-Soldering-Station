...
{ 
  ...
  Serial.println("C:\\Users\\Administrator\\Documents\\DXP\\AVR SOLDERING IRON\\FIRMWARE\\IRON_20");
  ...
  bmpDraw("SolderingStation2.bmp", 0, 0);
  Serial.println(F("SolderingStation2.bmp is ready."));
  delay(4000);
